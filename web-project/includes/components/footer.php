            ...
            <div class="row">
                ...
                <div class="col">
                    ...
                    <ul class="list-unstyled">
                        <li><a href="rooms.php" class="text-decoration-none text-light">Rooms</a></li>
                        <li><a href="news.php" class="text-decoration-none text-light">News</a></li>
                        <li><a href="myprofile.php" class="text-decoration-none text-light">My Profile</a></li> 
