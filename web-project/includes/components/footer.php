            ...
            <div class="row">
                ...
                <div class="col">
                    ...
                    <ul class="list-unstyled">
                        <li><a href="index.php?page=booking" class="text-decoration-none text-light">Rooms</a></li>
                        <li><a href="index.php?page=news" class="text-decoration-none text-light">News</a></li>
                        <li><a href="index.php?page=profile" class="text-decoration-none text-light">My Profile</a></li> 
                        <li><a href="index.php?page=impressum" class="text-decoration-none text-light">Impressum</a></li>
                        <li><a href="index.php?page=faq" class="text-decoration-none text-light">FAQ</a></li>
                    </ul>
                </div>
                <div class="col">
