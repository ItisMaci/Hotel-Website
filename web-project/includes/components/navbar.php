...
<nav class="navbar navbar-expand-lg bg-dark navbar-dark">
    <div class="container">
        ...
        <?php if(isset($_SESSION["loggedin"])){?>
            <a class="text-white" style="text-decoration:none;"> Willkommen <?php echo $username?></a>
        <?php }?>
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <div class="navbar-nav ms-auto">
                ...
                <a class="nav-link  <?= ($_GET["page"] ?? "booking") === "booking" ? "active" : ""?>" href="/web-project/index.php?page=booking">Booking</a>
                <a class="nav-link  <?= ($_GET["page"] ?? "impressum") === "impressum" ? "active" : ""?>"  href="index.php?page=impressum" class="text-decoration-none text-light">Impressum</a>
                <a class="nav-link  <?= ($_GET["page"] ?? "faq") === "faq" ? "active" : ""?>"  href="index.php?page=faq" class="text-decoration-none text-light">FAQ</a>
