...
if( $_SERVER['REQUEST_METHOD'] == 'GET'){
    ...
    do{
        ...
        $sql = "UPDATE users " .
        "SET id = '$id', firstName = '$firstName', lastName = '$lastName', username = '$username', email = '$email', pwd = '$hashedpwd' " .
        "WHERE id = '$id'";
...
<body>
    ...
    <form method="post">
        ...
        <div class="row mb-3">
                ...
                <div class="col-sm-6">
                    <input type="text" class="form-control" name="id" value="<?php echo $id_ ?>"> 
                </div>
        </div>
